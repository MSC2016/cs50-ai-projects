...
class NimAI():
    ...
    def get_q_value(self, state, action):
        ...
        """
        # cast state as a tuple and create a key (state, action)
        # search for that key in self.q and return its value or 0 if it doesnt exist 
    ...
    def best_future_reward(self, state):
        ...
        # Cast state into a tuple
        state = tuple(state)

        # List all possible actions for the current state
        ...
        for action in possible_actions:
            key = (state, action)
            # Get Q-value if it exists, else 0
